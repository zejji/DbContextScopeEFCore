...
/// <summary>
/// Indicates whether or not a new <see cref="IDbContextScope"/> will join the ambient scope.
/// </summary>
public enum DbContextScopeOption
{
    /// <summary>
    /// Join the ambient <see cref="IDbContextScope"/> if one exists. Creates a new
    /// one otherwise.
    ///
    ...
    /// <summary>
    /// Ignore the ambient <see cref="IDbContextScope"/> (if any) and force the creation of
    /// a new <see cref="IDbContextScope"/>.
    ///
    ...
    /// to the database when <see cref="IDbContextScope.SaveChanges()"/> is called in the inner scope
    /// regardless of whether or not the parent scope is successful.
    ///
