...
" + Environment.StackTrace;
    ...
    /// <summary>
    /// Makes the provided 'dbContextScope' available as the ambient scope via the AsyncLocal.
    /// </summary>
    static internal void SetAmbientScope(DbContextScope newAmbientScope)
    {
    ...
    /// </summary>
    static internal void RemoveAmbientScope()
    {
    ...
    /// </summary>
    static internal DbContextScope? GetAmbientScope()
    {
